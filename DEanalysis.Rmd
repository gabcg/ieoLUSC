...
So finally `r length(DEgenes)` genes calling differentially expressed, of which `r length(downDEgenes)` are downregulated and `r length(upDEgenes)` upregulated. As the chromosome information was added to the table of results, the chromosome distribution of these genes can be obtained. 
