...
The differential expression analysis results in `r length(rownames(tt)[tt$adj.P.Val < FDRcutoff])` significantly differentially expressed genes. Those can still be filtered by a log fold change cutoff of 2, with the following chromosome distribution.
