...
se.filt_go <- readRDS(file.path("results", "se.paired.filt.rds"))
...
```{r}
goresults_filt <- goresults[goresults$Size >= 5, ]
goresults_filt <- goresults[order(goresults$OddsRatio, decreasing=TRUE), ]
goresults_filt
```
