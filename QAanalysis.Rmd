...
par(mfrow=c(17, 3), mar=c(4, 5, 3, 1))
...
```{r maPlotsNormal, fig.height=36, fig.width=6, dpi=100, echo=FALSE, fig.cap="MA-plots of the normal samples."}
par(mfrow=c(18, 3), mar=c(4, 5, 3, 1))
